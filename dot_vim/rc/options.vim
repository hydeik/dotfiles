...
set backupdir=$VIM_CACHE_DIR/backup,~/tmp,/tmp
" directory to store swap files
set directory=$VIM_CACHE_DIR/swap,~/tmp,/tmp
" directory to store undo files
set undodir=$VIM_CACHE_DIR/undo,~/tmp,/tmp
" directory to store files for |:mkview|
set viewdir=$VIM_CACHE_DIR/view,~/tmp,/tmp
...
set viminfo='1000,<20,@50,h,n$VIM_CACHE_DIR/viminfo
" }}}
