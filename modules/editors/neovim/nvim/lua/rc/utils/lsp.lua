...
--     priority = 1,
--     format = function(buf)
--       M.format(lazy_utils.merge({}, filter, { bufnr = buf }))
--     end,
--     sources = function(buf)
--       local clients = M.get_client(lazy_utils.merge({}, filter, { bufnr = buf }))
--       ---@param client vim.lsp.Client
...
--     end,
--   }
--   return lazy_utils.merge(ret, opts) --[[@as LazyFormatter]]
-- end
--
-- ---@alias lsp.Client.format {timeout_ms?: number, format_options?: table} | lsp.Client.filter
--
...
--     {},
--     opts or {},
--     lazy_utils.get_plugin_opts "nvim-lspconfig",
--     lazy_utils.get_plugin_opts "conform.nvim"
--   )
