...
Copyright (c) 2021 TJ DeVries (MIT License)

This script is a part of astronauta.nvim (https://github.com/tjdevries/astronauta.nvim), which provides a Lua keymap DSL
proposed to be a part of Neovim core (https://github.com/neovim/neovim/pull/13823).
--]]
