...
" Create directories to store files generated by Vim if not exist
call s:mkdir("$VIM_CACHE_HOME/backup",  'p')
call s:mkdir("$VIM_CACHE_HOME/swap",    'p')
call s:mkdir("$VIM_CACHE_HOME/undo",    'p')
call s:mkdir("$VIM_CACHE_HOME/view",    'p')
call s:mkdir("$VIM_CACHE_HOME/session", 'p')
call s:mkdir("$VIM_DATA_HOME/spell",    'p')
